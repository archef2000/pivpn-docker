...
RUN apt-get update && apt-get install -y -f --no-install-recommends wireguard-tools qrencode gnupg \
openvpn grepcidr expect curl nano sudo systemd bsdmainutils bash-completion cron ca-certificates iproute2 \
